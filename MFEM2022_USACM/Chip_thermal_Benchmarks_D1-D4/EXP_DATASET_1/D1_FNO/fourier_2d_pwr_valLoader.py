...
if __name__ == '__main__':
    ...
    train_loader, val_loader, test_loader, x_normalizer, y_normalizer, x_test, y_test, n_train, n_val, n_test = get_dataLoader(batch_size, s)
        ...
        for ep in range(epochs):
            ...
            with torch.no_grad():
                if val_l2 < min_test_l2:
                    ...
                    x, y= x_test[idx:idx+1].cuda(DEVICE_NUM), y_test[idx:idx+1].cuda(DEVICE_NUM)
