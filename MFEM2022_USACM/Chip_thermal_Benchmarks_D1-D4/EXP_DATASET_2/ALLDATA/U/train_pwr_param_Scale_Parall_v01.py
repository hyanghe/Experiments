...
def train_net(net,
    ...
    # parameter_train = np.load(dir_data + 'parameters_train.npy')[:, [0, 2]]
...
##### Local shifting ####
    ...
    # parameter_test = np.load(dir_data + 'parameters_test.npy')[:, [0, 2]]
...
#     print('train_y max, min: ', train_y.max(), train_y.min())
#     # parameter_train = np.loadtxt(dir_data + 'parameters_train.txt', skiprows=1) 
#     parameter_train = np.load(dir_data + 'parameters_train.npy') 
...
#    # # test_x = dataset.load_power(dir_data + 'x_test.npy')
#     test_x = np.load(dir_data + 'x_train.npy')[:10]
#     test_y = np.load(dir_data + 'y_train.npy')[:10]
#     # parameter_test = np.loadtxt(dir_data + 'parameters_test.txt', skiprows=1)
#     parameter_test = np.load(dir_data + 'parameters_train.npy')[:10][:, [0, 2]]
